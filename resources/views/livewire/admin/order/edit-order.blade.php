                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <select wire:model="status_selected" class="w-full p-2 rounded-lg border border-gray-300">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="mt-4 space-y-2">
                        ...
                        <button wire:click="updateStatus()"
                            class="w-full bg-white hover:bg-gray-50 text-blue-700 font-medium py-2 px-4 rounded-lg border border-blue-700 transition-colors duration-200">
                            Cambiar estado
                        </button>
                    </div>
                </div>
